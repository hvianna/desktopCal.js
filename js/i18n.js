...
var msg = {
	en: {
		...
		creditTitle:'Credits',
		creditDescr:'Use this field to add photo credits and other informations.',
		front:      'Side 1',
		back:       'Side 2',
	...
	es: {
		...
		creditDescr:'Use este campo para agregar créditos fotográficos y otra información que desee.',
		front:      'Lado 1',
		back:       'Lado 2',
	...
	fr: {
		...
		creditTitle:'Crédits',
		creditDescr:'Utilisez ce champ pour ajouter des crédits photo et d\'autres informations.',
		front:      'Côté 1',
		back:       'Côté 2',
	...
	pt: {
		...
		creditTitle:'Créditos',
		creditDescr:'Use este campo para adicionar créditos das fotos e outras informações que desejar.',
		front:      'Lado 1',
		back:       'Lado 2',
